...
public class comercios extends AppCompatActivity
    ...
    private comercios.LocationChangeListeningActivityLocationCallback callback =
            new comercios.LocationChangeListeningActivityLocationCallback(this);

    private DatabaseReference mDatabase;
    private String nombreusuario;
    FloatingActionButton irMarcadorC;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        irMarcadorC = findViewById(R.id.irMarcadorC);
        ...
        irMarcadorC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(existeRuta){
                    mapboxMap.getStyle(new Style.OnStyleLoaded() {
                        ...
                        public void onStyleLoaded(@NonNull Style style) {
                            ...
                            NavigationLauncherOptions options = NavigationLauncherOptions.builder()
                                    ...
                                    .build();
                            NavigationLauncher.startNavigation(comercios.this, options);
                        }
                    });
                } else {
                    Toast.makeText(comercios.this,
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        comercios.this.mapboxMap = mapboxMap;
...
// Draw the route on the map
    ...
    private static class LocationChangeListeningActivityLocationCallback
        ...
        private final WeakReference<comercios> activityWeakReference;

        LocationChangeListeningActivityLocationCallback(comercios activity) {
            this.activityWeakReference = new WeakReference<>(activity);
        }

        @Override
        public void onSuccess(final LocationEngineResult result) {
            final comercios activity = activityWeakReference.get();
        ...
        public void onFailure(@NonNull Exception exception) {
            ...
            comercios activity = activityWeakReference.get();
            if (activity != null) {
