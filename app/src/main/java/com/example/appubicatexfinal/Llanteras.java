...
public class Llanteras extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    private Llanteras.LocationChangeListeningActivityLocationCallback callback =
            new Llanteras.LocationChangeListeningActivityLocationCallback(this);

    private DatabaseReference mDatabase;
    private String nombreusuario;
    FloatingActionButton irMarcadorL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_llanteras);
        ...
        irMarcadorL= findViewById(R.id.irMarcadorL);
        ...
        irMarcadorL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(existeRuta){
                    mapboxMap.getStyle(new Style.OnStyleLoaded() {
                        ...
                        public void onStyleLoaded(@NonNull Style style) {
                            ...
                            NavigationLauncherOptions options = NavigationLauncherOptions.builder()
                                    ...
                                    .build();
                            NavigationLauncher.startNavigation(Llanteras.this, options);
                        }
                    });
                } else {
                    Toast.makeText(Llanteras.this,
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        Llanteras.this.mapboxMap = mapboxMap;
...
// Draw the route on the map
    ...
    private static class LocationChangeListeningActivityLocationCallback
        ...
        private final WeakReference<Llanteras> activityWeakReference;

        LocationChangeListeningActivityLocationCallback(Llanteras activity) {
            this.activityWeakReference = new WeakReference<>(activity);
        }

        @Override
        public void onSuccess(final LocationEngineResult result) {
            final Llanteras activity = activityWeakReference.get();
        ...
        public void onFailure(@NonNull Exception exception) {
            ...
            Llanteras activity = activityWeakReference.get();
            if (activity != null) {
