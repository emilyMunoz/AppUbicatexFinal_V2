...
public class Centros_turisticos extends AppCompatActivity
    ...
    private static final int CODIGO = 4;
    ...
    private Centros_turisticos.LocationChangeListeningActivityLocationCallback callback =
            new Centros_turisticos.LocationChangeListeningActivityLocationCallback(this);

    private DatabaseReference mDatabase;
    private String nombreusuario;
    FloatingActionButton irMarcadorT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_centros_turisticos);
        mapView = findViewById(R.id.mapViewCentrosTuristicos);
        ...
        irMarcadorT = findViewById(R.id.irMarcadorT);
        ...
        irMarcadorT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(existeRuta){
                    mapboxMap.getStyle(new Style.OnStyleLoaded() {
                        ...
                        public void onStyleLoaded(@NonNull Style style) {
                            ...
                            NavigationLauncherOptions options = NavigationLauncherOptions.builder()
                                    ...
                                    .build();
                            NavigationLauncher.startNavigation(Centros_turisticos.this, options);
                        }
                    });
                } else {
                    Toast.makeText(Centros_turisticos.this,
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        Centros_turisticos.this.mapboxMap = mapboxMap;
...
// Draw the route on the map
    ...
    private static class LocationChangeListeningActivityLocationCallback
        ...
        private final WeakReference<Centros_turisticos> activityWeakReference;

        LocationChangeListeningActivityLocationCallback(Centros_turisticos activity) {
            this.activityWeakReference = new WeakReference<>(activity);
        }

        @Override
        public void onSuccess(final LocationEngineResult result) {
            final Centros_turisticos activity = activityWeakReference.get();
        ...
        public void onFailure(@NonNull Exception exception) {
            ...
            Centros_turisticos activity = activityWeakReference.get();
            if (activity != null) {
